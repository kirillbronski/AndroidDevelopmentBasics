...
class AdminViewModel(
    ...
    private fun toNode(accountsDataList: List<AccountFullData>, expandedIdentifiers: Set<Long>): Node {
        ...
        return Node(
            ...
            nodes = if (rootExpansion != ExpansionStatus.EXPANDED) emptyList() else accountsDataList.map { accountsData ->
                ...
                Node(
                    ...
                    nodes = if (accountExpansionStatus != ExpansionStatus.EXPANDED) emptyList() else accountsData.boxesAndSettings.map { boxAndSettings ->
