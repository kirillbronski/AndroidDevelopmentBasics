...
import com.kbcoding.androiddevelopmentbasics.data.sqlite.AppSQLiteContract.AccountsTable
...
class SQLiteAccountsRepositoryImpl(
    ...
    private fun getAccountById(accountId: Long): Account? {
        ...
        val cursor = db.query(
            AccountsTable.TABLE_NAME,
            arrayOf(
                AccountsTable.COLUMN_ID, AccountsTable.COLUMN_EMAIL, AccountsTable.COLUMN_USERNAME,
