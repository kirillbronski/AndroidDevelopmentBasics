package com.kbcoding.androiddevelopmentbasics.app.ui.views
...
class ResultView @JvmOverloads constructor(
    ...
    fun <T> setResult(fragment: BaseFragment<*>, result: ResponseResult<T>) {
        binding.messageTextView.isVisible = result is com.kbcoding.androiddevelopmentbasics.app.model.Error
        binding.errorButton.isVisible = result is com.kbcoding.androiddevelopmentbasics.app.model.Error
        binding.progressBar.isVisible = result is Pending
        if (result is com.kbcoding.androiddevelopmentbasics.app.model.Error) {
