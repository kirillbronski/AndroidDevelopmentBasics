package com.kbcoding.androiddevelopmentbasics.app.model.accounts
...
class AccountsRepository @Inject constructor(
     ...
     */
    fun getAccount(): Flow<com.kbcoding.androiddevelopmentbasics.app.model.ResponseResult<Account>> {
